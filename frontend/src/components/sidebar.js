        ...
        <div className="h-screen w-[18%]">
            ...
            <div className="flex flex-col justify-start items-start h-full sm:w-64 bg-slate-100">
                ...
                {/* <div className="flex flex-col justify-start items-center px-6 border-b border-gray-600 w-full  ">
                    <button onclick="showMenu1(true)" className="focus:outline-none focus:text-indigo-400 text-left  text-black flex justify-between items-center w-full py-5 space-x-14  ">
                    ...
                    <div id="menu1" className="flex justify-start  flex-col w-full md:w-auto items-start pb-1 ">
                        <button className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-900 rounded px-3 py-2  w-full md:w-52">
                ...
                {/* <div className="flex flex-col justify-center items-baseline h-full px-6 w-full space-y-10">
