...
export default function Sidebar() {
    ...
    return (
        <div className="h-screen w-[18%]">
            ...
            <div className="flex flex-col justify-between items-start h-full sm:w-64 bg-slate-100">
                <div>
                    ...
                    <div className="px-3 w-full">
                        <div className="pl-[7%] flex flex-col justify-start items-center w-full border-gray-400 border-b space-y-2.5 pb-3">
                            <button className="flex jusitfy-start items-center space-x-5 w-full text-gray-600 hover:text-gray-900 font-medium">
    ...
    `} type="button" id="SortDropdownButton" onClick={toggleSortDropdown} >
                            ...
                            {isSortDropdownOpen && (
                                <div id="sortdropdown" className="relative my-2 right-0 z-10 w-50 origin-top-right rounded-md bg-white shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none">
                                    <div class="py-1" role="none">
                                        <a href="#" class="text-gray-500 hover:text-gray-800 hover:bg-gray-100 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-1">Price(Low to High)</a>
                                        <a href="#" class="text-gray-500 hover:text-gray-800 hover:bg-gray-100 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-2">Date</a>
                                        <a href="#" class="text-gray-500 hover:text-gray-800 hover:bg-gray-100 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-3">Booked Slots</a>
                                    </div>
                                </div>
                            )}
                        </div>
                        <div className="px-[9%] py-2.5 relative border-gray-400 border-b">
                            ...
                            {isSearchDropdownOpen && (
                                <div id="searchdropdown" className="relative my-2 right-0 z-10 w-5+0 origin-top-right rounded-md bg-white shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none">
                                    <div class="py-1" role="none">
                                        <a href="#" class="text-gray-500 hover:text-gray-800 hover:bg-gray-100 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-1">Name</a>
                                        <a href="#" class="text-gray-500 hover:text-gray-800 hover:bg-gray-100 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-2">Price</a>
                                    </div>
                                </div>
                            )}
                        </div>
                ...
                <div className="w-full px-3">
                    <div className="flex justify-between px-[2%] py-3 items-center space-x-3 border-b border-gray-400">
                        <div className="h-8 w-8 rounded-md shadow-xl shadow-gray-400 overflow-hidden">
