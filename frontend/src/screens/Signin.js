...
export default function Signin() {
  return (
    <section className="bg-gray-400 dark:bg-slate-100">
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        ...
        <div className="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0 dark:bg-white">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" action="/signin" method="post">
              <div>
              ...
              <p className="text-sm text-center font-light text-gray-500 dark:text-gray-400">
                New to Propshop?
                <Link to="/UserSignup" className="font-medium text-blue-600 hover:underline cursor-pointer ml-2">
                  Sign up
                </Link>
              </p>
            </form>
