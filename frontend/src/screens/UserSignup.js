      ...
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        ...
        <div className="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0 dark:bg-white">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" action="/usersignup" method="post">
              <div>
              ...
              <div>
                <input type="text" name="contactno" id="contactno" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-base rounded-md block w-full p-2.5 dark:bg-transparent dark:border-gray-300 dark:placeholder-gray-500 focus:placeholder-gray-400 focus:border-none" placeholder="Mobile Number" required />
              </div>
              <div>
              ...
              <p className="text-sm text-center font-light text-gray-500 dark:text-gray-400">
                ...
                <Link to="/signin" className="font-medium text-blue-600 hover:underline cursor-pointer ml-2">
                  Sign In
                </Link>
              </p>
            </form>
